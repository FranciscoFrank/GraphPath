...
Q_CONSTINIT static const qt_meta_stringdata_ThemeManager_t qt_meta_stringdata_ThemeManager = {
    {
        ...
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 9),  // "ThemeType"
        QT_MOC_LITERAL(37, 8)   // "newTheme"
    },
    "ThemeManager",
    "themeChanged",
    "",
...
Q_CONSTINIT const QMetaObject ThemeManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ThemeManager_t,
        ...
        QtPrivate::TypeAndForceComplete<ThemeType, std::false_type>
    >,
    nullptr
} };
...
void ThemeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->themeChanged((*reinterpret_cast< std::add_pointer_t<ThemeType>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ThemeManager::*)(ThemeType );
...
// SIGNAL 0
void ThemeManager::themeChanged(ThemeType _t1)
{
